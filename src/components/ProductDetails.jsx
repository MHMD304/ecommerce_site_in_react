...
const ProductDetails = () => {
  ...
  if (!pData)
    return <div className="error-message">{product.errorMessage}</div>;

  const { id, title, image, specs, features, price, stock, description } =
    pData;
  ...
  return (
    <article>
      ...
      {description && (
        <Description dangerouslySetInnerHTML={markUp()}></Description>
      )}
    </article>
  );
};
